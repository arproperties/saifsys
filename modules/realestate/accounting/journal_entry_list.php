<?php
/**
 * Real Estate Accounting - Journal Entries List
 * Lists all journal entries with filters
 */
...
$isPosted = !empty($_GET['is_posted']) ? $_GET['is_posted'] : '';
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="journal_entry_view.php?id=<?= $journal['id'] ?>" class="btn btn-outline-primary" title="View">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <?php if (!$journal['is_posted']): ?>
                                            <a href="journal_entry_add.php?id=<?= $journal['id'] ?>" class="btn btn-outline-info" title="Edit">
