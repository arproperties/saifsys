...
$feedReady = co_bank_feed_table_ready($conn);
$connections = $feedReady ? co_bank_feed_connections_list($conn, $cid) : [];
...
<?php if (!$feedReady): ?>
  <div class="alert alert-warning">Run <code>migrations/construction_bank_reconciliation_v3.sql</code> to enable the bank feeds registry.</div>
<?php else: ?>
