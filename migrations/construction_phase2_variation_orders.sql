-- ============================================================================
-- CONSTRUCTION MODULE — Phase 2: Variation Orders
-- ============================================================================
-- Run after construction_phase2_project_phases.sql
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS `co_variation_orders` (
  ...
  `project_contractor_id` INT(11) DEFAULT NULL COMMENT 'Optional: VO for specific project-contractor',
  `vo_number` VARCHAR(50) NOT NULL COMMENT 'e.g. VO-001',
