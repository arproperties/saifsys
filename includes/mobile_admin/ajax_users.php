...
try {
    switch ($action) {
        case 'toggle_status':
            ...
            error_log("✅ User status updated - Client ID: $clientId, Status: " . ($status ? 'Active' : 'Inactive'));
        ...
        case 'delete_user':
            ...
            error_log("✅ User deactivated - Client ID: $clientId");
    ...
    error_log("❌ Mobile Users AJAX Error: " . $e->getMessage());
    echo json_encode([
        'success' => false,
