...
-- Add column: company_id (safe check)
SET @col_exists = (
    SELECT COUNT(*) 
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in attendance" AS message'
);
...
-- Add index: idx_company_id (safe check)
SET @idx_exists = (
    SELECT COUNT(*) 
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in attendance" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in chart_of_accounts" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in chart_of_accounts" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in client" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in client" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in company_settings" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- Add index: uq_company_settings (safe check)
SET @idx_exists = (
    SELECT COUNT(*) 
    FROM INFORMATION_SCHEMA.STATISTICS 
    WHERE TABLE_SCHEMA = DATABASE() 
    AND TABLE_NAME = 'company_settings' 
    AND INDEX_NAME = 'uq_company_settings'
);
SET @sql = IF(@idx_exists = 0,
    'ALTER TABLE `company_settings` ADD INDEX `uq_company_settings` (`company_id`)',
    'SELECT "Index uq_company_settings already exists in company_settings" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in credit_notes" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in credit_notes" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in employees" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in employees" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in employee_documents" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in employee_documents" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in expenses" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in expenses" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in gl_journals" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in gl_journals" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in invoices" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in invoices" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in leave_requests" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in leave_requests" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in make_order" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in make_order" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in overtime_entries" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in overtime_entries" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in payroll_runs" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in payroll_runs" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in receipts" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in receipts" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in refunds" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in refunds" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column module already exists in roles" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- Add column: is_system (safe check)
SET @col_exists = (
    SELECT COUNT(*) 
    FROM INFORMATION_SCHEMA.COLUMNS 
    WHERE TABLE_SCHEMA = DATABASE() 
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column is_system already exists in roles" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- Add index: idx_module (safe check)
SET @idx_exists = (
    SELECT COUNT(*) 
    FROM INFORMATION_SCHEMA.STATISTICS 
    WHERE TABLE_SCHEMA = DATABASE() 
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_module already exists in roles" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in services" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in services" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- Add column: default_company_id (safe check)
SET @col_exists = (
    SELECT COUNT(*) 
    FROM INFORMATION_SCHEMA.COLUMNS 
    WHERE TABLE_SCHEMA = DATABASE() 
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column default_company_id already exists in user" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in user" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- Add index: idx_default_company (safe check)
SET @idx_exists = (
    SELECT COUNT(*) 
    FROM INFORMATION_SCHEMA.STATISTICS 
    WHERE TABLE_SCHEMA = DATABASE() 
    AND TABLE_NAME = 'user' 
    AND INDEX_NAME = 'idx_default_company'
);
SET @sql = IF(@idx_exists = 0,
    'ALTER TABLE `user` ADD INDEX `idx_default_company` (`default_company_id`)',
    'SELECT "Index idx_default_company already exists in user" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in user" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@col_exists = 0,
    ...
    'SELECT "Column company_id already exists in vendors" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF(@idx_exists = 0,
    ...
    'SELECT "Index idx_company_id already exists in vendors" AS message'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
